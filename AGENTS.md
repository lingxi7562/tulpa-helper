...
### 11. Working debug APK architecture
```
src-tauri/gen/android/app/build/outputs/apk/**/debug/*.apk
```
CI verifies that this glob resolves to exactly one APK containing only `lib/arm64-v8a`. The exact directory/file name is generated by the Tauri/Gradle version.
